...
<div id="container"><!-- InstanceBeginEditable name="EditRegion1" -->
  <div id="primaryContent">
    <h2>討論區</h2>
    <h3>您可以在此瀏覽您有興趣的主題參與討論！</h3>
    <p><a href="createTitle.php">我有主題</a></p>
    <br/>
<table width="95%" border="0">
      ...
      <?php do { ?>
        <tr>
          <th scope="row"><p><a href="detailsView.php?titleid=<?php echo $row_Recordset1['titleid']; ?>"><?php echo $row_Recordset1['subject']; ?></a></p></th>
          <td><p><?php echo $row_Recordset1['name']; ?></p></td>
          <td><p><?php echo $row_Recordset1['count']; ?></p></td>
          <td><p><?php echo $row_Recordset1['createDate']; ?></p></td>
        </tr>
