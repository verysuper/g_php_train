...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO guestbook (name, email, subject, memo, lastdate) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['name'], "text"),
                       GetSQLValueString($_POST['email'], "text"),
                       GetSQLValueString($_POST['subject'], "text"),
                       GetSQLValueString($_POST['memo'], "text"),
                       GetSQLValueString($_POST['lastdate'], "date"));
...
<div id="container"><!-- InstanceBeginEditable name="EditRegion1" -->
  <div id="primaryContent">
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" id="form1">
      ...
      <input type="hidden" name="lastdate" value="<?php echo date("Y-m-d H:i:s");?>" />
