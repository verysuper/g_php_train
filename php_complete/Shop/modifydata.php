    ...
    <form name="form1" id="form1" method="POST" action="<?php echo $editFormAction; ?>">
      <table width="95%%" border="0">
        ...
        <tr>
          ...
          <td align="left"><textarea name="address" cols="32" rows="2" id="address"><?php echo $row_Recordset1['address']; ?></textarea></td>
        </tr>
        <tr>
          <th colspan="2" align="center" scope="row"><button type="submit" name="button" id="button" value="送出" >送出</button>
          <input name="userid" type="hidden" id="userid" value="<?php echo $row_Recordset1['userid']; ?>" /></th>
        </tr>
      </table>
