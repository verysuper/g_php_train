...
mysql_select_db($database_Shop, $Shop);
$query_RecordShipment = "SELECT * FROM orders";
$RecordShipment = mysql_query($query_RecordShipment, $Shop) or die(mysql_error());
$row_RecordShipment = mysql_fetch_assoc($RecordShipment);
$totalRows_RecordShipment = mysql_num_rows($RecordShipment);
 session_start();?>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RecordShipment);
?>
