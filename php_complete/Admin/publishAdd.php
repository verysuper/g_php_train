...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO publish (title, name, content, url, expire, `update`) VALUES (%s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" id="form1">
  <table>
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="name" value="<?php echo $_SESSION['MM_Username'];?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td align="right" valign="top">內容:</td>
        <td><textarea name="content" cols="46" rows="6"></textarea></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="expire" value="" size="32" />        
          YYYY/MM/DD</td>
      </tr>
      <tr valign="baseline">
        <td align="right">&nbsp;</td>
        <td><button type="submit" value="插入記錄" >插入記錄</button></td>
      </tr>
    </table>
