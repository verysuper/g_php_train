...
var nc 
  ...
  if (level>0) 
    ...
    { 
      this.renderOb(leftSide + auxEv + "<img name='./images/nodeIcon" + this.id + "' src='./images/mlastnode.gif' width=16 height=22 border=0></a>") 
      leftSide = leftSide + "<img src='./images/blank.gif' width=16 height=22>"  
      this.isLastNode = 1 
    } 
    else 
    { 
      this.renderOb(leftSide + auxEv + "<img name='./images/nodeIcon" + this.id + "' src='./images/mnode.gif' width=16 height=22 border=0></a>") 
