...
$query_Recordset1 = "SELECT * FROM gbook ORDER BY `date` DESC";
...
mysql_select_db($database_sql2, $sql2);
$query_Recordset1 = "SELECT * FROM gbook ORDER BY `date` DESC";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $sql2) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<?php do { ?>
  <table width="611" border="1" align="center">
    <tr>
      <td width="306">作者：<?php echo $row_Recordset1['name']; ?></td>
      <td width="289">電子郵件：<?php echo $row_Recordset1['email']; ?></td>
    </tr>
    <tr>
      <td colspan="2">主題：<?php echo $row_Recordset1['subject']; ?></td>
    </tr>
    <tr>
      <td colspan="2"><?php echo $row_Recordset1['memo']; ?></td>
    </tr>
    <tr>
      <td colspan="2" align="right">時間：<?php echo $row_Recordset1['date']; ?></td>
    </tr>
  </table>
