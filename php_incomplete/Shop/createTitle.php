...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO titles (email, name, subject, memo, createDate, lastNewsDate, `count`) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['email'], "text"),
                       GetSQLValueString($_POST['name'], "text"),
                       GetSQLValueString($_POST['subject'], "text"),
                       GetSQLValueString($_POST['memo'], "text"),
                       GetSQLValueString($_POST['createDate'], "date"),
                       GetSQLValueString($_POST['lastNewsDate'], "date"),
                       GetSQLValueString($_POST['count'], "int"));
...
<div id="container"><!-- InstanceBeginEditable name="EditRegion1" -->
  <div id="primaryContent">
    ...
    <input type="hidden" name="lastNewsDate" value="<?php echo date("Y-m-d H:i:s"); ?>">
